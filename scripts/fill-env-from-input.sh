...
# Script pour remplir les .env.local avec les credentials fournis
# Usage: ./scripts/fill-env-from-input.sh
...
echo "======================================"
echo ""
echo "📋 Fournissez vos credentials:"
echo ""
...
# Générer JWT secrets
echo ""
echo "🔐 Génération des JWT secrets..."
...
echo ""
echo "📝 Création de apps/backend/.env.local..."
...
read -p "🔴 Upstash REST URL (https://...): " UPSTASH_REST_URL
read -p "🔴 Upstash REST Token: " UPSTASH_REST_TOKEN

echo ""
echo "📝 Création de apps/frontend/.env.local..."
