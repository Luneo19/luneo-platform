...
# Script pour finaliser la configuration avec les credentials fournis

set -e

echo "⚙️ Finalisation de la Configuration"
echo "===================================="
echo ""
...
echo "   ✅ Upstash REST URL et Token"
