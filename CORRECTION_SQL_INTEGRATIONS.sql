-- ═══════════════════════════════════════════════════════════════
-- 🔧 CORRECTION - SUPPRIMER ET RECRÉER TABLE INTEGRATIONS
-- ═══════════════════════════════════════════════════════════════
...
-- ============================================
-- ÉTAPE 2: Créer la table integrations
-- ============================================
...
-- ============================================
-- ÉTAPE 3: Créer la table sync_logs
-- ============================================
...
-- Fonction calculate_sync_duration
...
-- Fonction update_integration_stats
...
-- ═══════════════════════════════════════════════════════════════
-- ✅ TABLES INTEGRATIONS RECRÉÉES AVEC SUCCÈS !
-- ═══════════════════════════════════════════════════════════════
