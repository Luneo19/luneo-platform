  ...
  return (
    <div className="space-y-6">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">2h 15min</p>
              </div>
              <Clock className="w-8 h-8 text-cyan-400" />
            </div>
            <Progress value={75} className="h-2" />
            <p className="text-xs text-gray-600 mt-2">Objectif: &lt; 2h</p>
          </CardContent>
        </Card>
        <Card className="bg-white border-gray-200">
          <CardContent className="p-6">
            ...
            <p className="text-xs text-gray-600 mt-2">Objectif: &gt; 85%</p>
          </CardContent>
        </Card>
        <Card className="bg-white border-gray-200">
          <CardContent className="p-6">
            ...
            <div className="flex items-center gap-1 mt-2">
              {Array.from({ length: 5 }).map((_, i) => (
                <Star
                  key={i}
                  className={cn('w-4 h-4', i < 4 ? 'text-yellow-400 fill-yellow-400' : 'text-gray-400')}
                />
              ))}
            </div>
          </CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="bg-white border-gray-200">
          <CardHeader>
            <CardTitle className="text-gray-900">Tickets par catégorie</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white border-gray-200">
          <CardHeader>
            <CardTitle className="text-gray-900">Évolution des tickets</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="h-[300px] flex items-center justify-center text-gray-600">
