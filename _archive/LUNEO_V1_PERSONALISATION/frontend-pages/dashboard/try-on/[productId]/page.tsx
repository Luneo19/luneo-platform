...
function TryOnProductPageContent() {
...
const MemoizedTryOnProductPageContent = memo(TryOnProductPageContent);

export default function TryOnProductPage() {
  return (
    <ErrorBoundary level="page" componentName="TryOnProductPage">
      <MemoizedTryOnProductPageContent />
    </ErrorBoundary>
  );
}
