...
const ProductCustomizerMemo = memo(ProductCustomizerComponent);

export const ProductCustomizer = (props: ProductCustomizerProps) => {
  return (
    <ErrorBoundary componentName="ProductCustomizer">
      <ProductCustomizerMemo {...props} />
    </ErrorBoundary>
  );
};