...
const SelectionToolContentMemo = memo(SelectionToolContent);

export default function SelectionTool(props: SelectionToolProps) {
  return (
    <ErrorBoundary componentName="SelectionTool">
      <SelectionToolContentMemo {...props} />
    </ErrorBoundary>
  );
}
