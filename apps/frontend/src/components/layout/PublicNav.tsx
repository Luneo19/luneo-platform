          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            >
              <button 
                ...
                className="flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 font-medium rounded-md hover:bg-gray-50 transition-colors"
                data-testid="nav-dropdown-solutions"
              >
                Solutions
                <ChevronDown className="w-4 h-4 ml-1" />
              </button>
            ...
            >
              <button 
                ...
                className="flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 font-medium rounded-md hover:bg-gray-50 transition-colors"
                data-testid="nav-dropdown-pricing"
              >
                Tarifs
                <ChevronDown className="w-4 h-4 ml-1" />
              </button>
            ...
            >
              <button 
                ...
                className="flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 font-medium rounded-md hover:bg-gray-50 transition-colors"
                data-testid="nav-dropdown-company"
              >
                Entreprise
                <ChevronDown className="w-4 h-4 ml-1" />
              </button>
...
const PublicNavContentMemo = memo(PublicNavContent);

export function PublicNav() {
  return (
    <ErrorBoundary componentName="PublicNav">
      <PublicNavContentMemo />
    </ErrorBoundary>
  );
}
