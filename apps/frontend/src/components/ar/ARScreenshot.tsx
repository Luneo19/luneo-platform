...
function ARScreenshotContent({ productName, onShare }: ARScreenshotProps) {
    ...
    <Card>
      ...
      {screenshot && (
        <CardFooter className="flex gap-2">
          ...
          <Button onClick={clearScreenshot} variant="ghost">
            <X className="h-4 w-4" />
          </Button>
        </CardFooter>
      )}
...
const ARScreenshotContentMemo = memo(ARScreenshotContent);

export function ARScreenshot(props: ARScreenshotProps) {
  return (
    <ErrorBoundary componentName="ARScreenshot">
      <ARScreenshotContentMemo {...props} />
    </ErrorBoundary>
  );
}
