    ...
    <div className="min-h-screen bg-gray-900 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-4 mt-4">Webhooks Setup</h1>
          <p className="text-xl text-gray-400">Configurez vos webhooks</p>
        </div>
