...
function FirstCustomizerPageContent() {
  ...
  const codeExample1 = useMemo(() => `import { LuneoClient } from '@luneo/sdk';
...
const product = await client.products.create({
  ...
  const codeExample2 = useMemo(() => `import { ProductCustomizer } from '@luneo/react';
...
export default function CustomizePage() {
  ...
  const codeExample3 = useMemo(() => `const config = {
  canvas: {
    width: 800,
    height: 1000,
...
const FirstCustomizerPageMemo = memo(FirstCustomizerPageContent);

export default function FirstCustomizerPage() {
  return (
    <ErrorBoundary componentName="FirstCustomizerPage">
      <FirstCustomizerPageMemo />
    </ErrorBoundary>
  );
}
