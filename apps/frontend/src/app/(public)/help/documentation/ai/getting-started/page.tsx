...
console.log('Generated:', design.image_url);`;
    ...
    <div className="min-h-screen bg-gray-900 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-4 mt-4">AI Generation - Getting Started</h1>
          <p className="text-xl text-gray-400">Générez avec DALL-E 3</p>
        </div>

        <Card className="p-6 bg-gray-800/50 border-gray-700 mb-8">
          <h2 className="text-2xl font-bold text-white mb-4">Exemple Simple</h2>
        ...
        <Card className="p-6 bg-gray-800/50 border-gray-700">
          <h2 className="text-2xl font-bold text-white mb-4">Styles Disponibles</h2>
          <div className="space-y-2 text-gray-300">
            <div className="flex gap-2"><CheckCircle className="w-5 h-5 text-pink-400" /> Photorealistic</div>
            <div className="flex gap-2"><CheckCircle className="w-5 h-5 text-pink-400" /> Artistic</div>
            <div className="flex gap-2"><CheckCircle className="w-5 h-5 text-pink-400" /> Minimalist</div>
            <div className="flex gap-2"><CheckCircle className="w-5 h-5 text-pink-400" /> Vintage</div>
          </div>
        </Card>
      </div>
    </div>
