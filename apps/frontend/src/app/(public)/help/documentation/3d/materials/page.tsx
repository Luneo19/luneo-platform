...
function ThreeDMaterialsPageContent() {
  ...
  const materialExample = useMemo(() => `// PBR Materials
const materials = {
  wood: {
...
const ThreeDMaterialsPageMemo = memo(ThreeDMaterialsPageContent);

export default function ThreeDMaterialsPage() {
  return (
    <ErrorBoundary componentName="ThreeDMaterialsPage">
      <ThreeDMaterialsPageMemo />
    </ErrorBoundary>
  );
}
