        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-6 sm:mt-8">
              {['Démarrage rapide', 'API Reference', 'Exemples', 'Vidéos'].map(link => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {sections.map((section, index) => (
              ...
              >
                <Card className="p-4 sm:p-6 h-full bg-white/5 border-white/10 hover:border-white/30 hover:bg-white/10 transition-all group backdrop-blur-sm">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <Card className="p-4 sm:p-6 md:p-8 bg-gray-900 text-white">
            <div className="flex items-center justify-between mb-4">
              ...
              <Button size="sm" variant="outline" className="text-white border-gray-600 hover:bg-gray-800 text-xs sm:text-sm">
                Copier
              </Button>
            </div>
            
            <pre className="text-xs sm:text-sm overflow-x-auto">
              <code>{`import { LuneoCustomizer } from '@luneo/react';
