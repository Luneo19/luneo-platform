    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="mt-12 bg-gray-800/50 rounded-xl p-8 border border-gray-700">
          ...
          <p className="text-gray-300 mb-4">Vous avez trouvé une faille de sécurité ? Contactez-nous en privé :</p>
          <a href="mailto:security@luneo.app" className="text-blue-400 hover:text-blue-300 font-semibold">security@luneo.app</a>
        </div>
      </section>
    </div>
  );
