...
import { Printer, MessageSquare, Settings, ExternalLink } from 'lucide-react';
  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="text-4xl sm:text-5xl font-bold mb-6">Prêt à lancer votre business print-on-demand ?</h2>
