...
function ShowcasePageContent() {
  ...
  return (
    <ErrorBoundary level="page" componentName="ShowcasePage">
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {showcases.map((item, idx) => (
            <div key={idx} className="bg-gray-800/50 rounded-xl shadow-lg overflow-hidden border border-gray-700 hover:border-gray-600 hover:shadow-2xl transition-all">
...
const ShowcasePageMemo = memo(ShowcasePageContent);

export default function ShowcasePage() {
  return (
    <ErrorBoundary componentName="ShowcasePage">
      <ShowcasePageMemo />
    </ErrorBoundary>
  );
}
