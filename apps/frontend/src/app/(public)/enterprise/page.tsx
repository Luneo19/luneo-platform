...
export const metadata = {
  title: 'Luneo Enterprise - Solutions pour Grandes Entreprises',
  description: 'Solutions personnalisées, SLA garantis, support dédié 24/7 pour les grandes entreprises',
};
