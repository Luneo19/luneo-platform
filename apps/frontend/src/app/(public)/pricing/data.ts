...
export const PLANS: Plan[] = [
  {
    ...
    limits: { designs: 5, renders2D: 10, renders3D: 0, storage: '0.5 GB', teamMembers: 1, apiCalls: 0 },
  },
  {
    id: 'starter',
    name: 'Starter',
    ...
    features: [
      ...
      '5 GB stockage', 'Commission 12%', 'Add-ons disponibles',
    ],
    limits: { designs: 50, renders2D: 100, renders3D: 10, storage: '5 GB', teamMembers: 3, apiCalls: 10000 },
  },
  {
    id: 'professional',
    name: 'Professional',
    ...
    features: [
      ...
      '10 membres d\'equipe', '25 GB stockage', 'White-label', 'Webhooks temps reel', 'Commission 10%',
    ],
    limits: { designs: 200, renders2D: 500, renders3D: 50, storage: '25 GB', teamMembers: 10, apiCalls: 50000 },
  },
  {
    id: 'business',
    name: 'Business',
    ...
    features: [
      ...
      '100 GB stockage', 'SLA 99.5%', 'Commission 7%',
    ],
    limits: { designs: 1000, renders2D: 2000, renders3D: 200, storage: '100 GB', teamMembers: 50, apiCalls: 200000 },
  },
  {
    id: 'enterprise',
    name: 'Enterprise',
    ...
    features: [
      ...
      'Integrations custom', 'Commission 5%',
    ],
    limits: { designs: 'Illimite', renders2D: 'Illimite', renders3D: 'Illimite', storage: 'Illimite', teamMembers: 'Illimite', apiCalls: 'Illimite' },
  },
];
...
export const FAQS: { question: string; answer: string }[] = [
  ...
  { question: 'Que se passe-t-il si je dépasse mes limites ?', answer: 'Sur les plans Starter et Professional, vous recevrez une notification lorsque vous approchez de vos limites. Sur le plan Business, vous pouvez acheter des crédits supplémentaires. Sur Enterprise, les limites sont flexibles selon vos besoins.' },
