...
function EntreprisePageContent() {
  const features = [
...
const MemoizedEntreprisePageContent = memo(EntreprisePageContent);

export default function EntreprisePage() {
  return (
    <ErrorBoundary level="page" componentName="EntreprisePage">
      <MemoizedEntreprisePageContent />
    </ErrorBoundary>
  );
}
