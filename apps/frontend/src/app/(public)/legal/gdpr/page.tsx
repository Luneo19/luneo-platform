        ...
        <div className="prose prose-lg max-w-none prose-invert">
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700">
              <h3 className="font-semibold text-white mb-3">Données d'identification :</h3>
              ...
              <h3 className="font-semibold text-white mb-3 mt-6">Données de création :</h3>
              <ul className="list-disc pl-6 text-gray-300 space-y-1">
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">8. Contact DPO</h2>
            <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700">
