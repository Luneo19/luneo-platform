    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="max-w-5xl mx-auto px-4 py-20">
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <p className="text-gray-700 mb-2">Pour toute demande média :</p>
          <a href="mailto:press@luneo.app" className="text-blue-600 hover:text-blue-700 font-semibold">press@luneo.app</a>
        </div>
        <div className="bg-white rounded-xl shadow-lg p-8">
          <h2 className="text-2xl font-bold mb-4">Press Kit</h2>
          <p className="text-gray-700 mb-4">Téléchargez notre press kit avec logos, screenshots, et assets.</p>
