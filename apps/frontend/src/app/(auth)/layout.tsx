  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
        ...
        <div className="relative z-10 flex flex-col justify-between p-8 xl:p-12 w-full">
          ...
          <div>
            <Link href="/" className="inline-flex items-center gap-3 group">
              ...
              <span className="text-white font-bold text-xl tracking-tight">Luneo</span>
            </Link>
          </div>
      ...
      <div className="flex-1 lg:w-1/2 xl:w-[45%] bg-slate-950 lg:bg-slate-900 relative min-h-screen">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-slate-950 via-slate-900 to-cyan-950/30 pointer-events-none lg:hidden" />
      </div>
    </div>
  );
}
