/**
 * ★★★ API ROUTE - EDITOR PROJECT HISTORY ★★★
 * Next.js route to add a history entry to an editor project
 */
...
export async function POST(
  ...
  return ApiResponseBuilder.handle(async () => {
    ...
    const resp = await fetch(`${backendUrl}/api/editor/projects/${params.id}/history`, {
      method: 'POST',
      headers: {
  ...
  }, '/api/editor/projects/[id]/history', 'POST');
}
