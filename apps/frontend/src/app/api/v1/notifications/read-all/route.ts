/**
 * User notifications read-all API proxy.
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    const res = await fetch(`${getBackendUrl()}/api/v1/notifications/read-all`, {
      method: 'POST',
    ...
    serverLogger.apiError('/api/v1/notifications/read-all', 'POST', error, 500);
