/**
 * User notification mark-as-read API proxy.
 */
...
export async function POST(
  ...
  try {
    ...
    const res = await fetch(`${getBackendUrl()}/api/v1/notifications/${id}/read`, {
      method: 'POST',
    ...
    serverLogger.apiError('/api/v1/notifications/[id]/read', 'POST', error, 500);
