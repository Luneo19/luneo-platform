  ...
  const [templates, setTemplates] = useState<Template[]>([
    {
      ...
      category: 'tshirt',
      thumbnail: '/templates/tshirt-1.jpg',
      isPremium: false,
      isFavorite: true,
      downloads: 1240,
      views: 5680,
      ...
      tags: ['basique', 'blanc', 'coton']
    },
    {
      id: '2',
      name: 'Mug Personnalisé 11oz',
      category: 'mug',
      thumbnail: '/templates/mug-1.jpg',
      isPremium: true,
      isFavorite: false,
      downloads: 890,
      views: 3420,
      ...
      tags: ['céramique', 'blanc', 'premium']
    },
    {
      id: '3',
      name: 'Poster A3 Haute Qualité',
      category: 'poster',
      thumbnail: '/templates/poster-1.jpg',
      isPremium: true,
      isFavorite: true,
      downloads: 2340,
      views: 8920,
      ...
      tags: ['papier', 'brillant', 'a3']
    },
    {
      id: '4',
      name: 'Stickers Ronds',
      category: 'sticker',
      thumbnail: '/templates/sticker-1.jpg',
      isPremium: false,
      isFavorite: false,
      downloads: 456,
      views: 1890,
      ...
      tags: ['vinyle', 'rond', 'petit']
    },
    {
      id: '5',
      name: 'Carte de Visite Premium',
      category: 'card',
      thumbnail: '/templates/card-1.jpg',
      isPremium: true,
      isFavorite: false,
      downloads: 678,
      views: 2340,
      ...
      tags: ['business', 'premium', 'recto-verso']
    }
  ]);
  ...
  const loadTemplates = async (pageNum: number = 1, append: boolean = false) => {
    ...
    try {
      const response = await fetch(
        `/api/library/templates?page=${pageNum}&limit=${ITEMS_PER_PAGE}&category=${categoryFilter}&search=${encodeURIComponent(searchTerm)}&sort=${sortBy}`
      );
      if (!response.ok) {
      ...
      if (!append) {
        toast({
          title: 'Erreur',
          description: error.message || 'Impossible de charger les templates',
          variant: 'destructive',
        });
      }
    } finally {
