          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-4">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-purple-400">{Math.round(stats.usageRate)}%</p>
              </div>
            </div>
          </div>
          <div className="text-right">
            ...
            {autoRefillEnabled && (
              <div className="p-3 bg-green-500/10 border border-green-500/30 rounded-lg">
                ...
                <p className="text-xs text-gray-400">Recharge automatique à {autoRefillThreshold} crédits</p>
              </div>
            )}
          </div>
        </div>
