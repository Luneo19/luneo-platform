...
import {
  ...
  GiftCardBookmarkOff,
  GiftCardMessage,
  GiftCardMessageSquare,
  GiftCardMessageCircle,
  GiftCardMessageDots,
  GiftCardMessagePlus,
  GiftCardMessageMinus,
  GiftCardMessageX,
  GiftCardMessageCheck,
  GiftCardMessageQuestion,
  GiftCardMessageWarning,
  GiftCardMessageAlert,
  GiftCardMessageInfo,
  GiftCardMessageCode,
  GiftCardMessageEdit,
  GiftCardMessageReply,
  GiftCardMessageForward,
  GiftCardMessageShare,
  GiftCardMessageCopy,
  GiftCardMessageLink,
