...
export function MonitoringMetrics({ metrics }: MonitoringMetricsProps) {
    ...
    return (
      <Card className="bg-white border-gray-200">
        <CardContent className="p-8 text-center">
          <p className="text-gray-600">Aucune métrique disponible</p>
        </CardContent>
      </Card>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-white border-gray-200">
        <CardHeader>
          <CardTitle className="text-gray-900">Métriques de performance</CardTitle>
          <CardDescription className="text-gray-600">Web Vitals et temps de réponse</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {metrics.avgWebVitals.LCP && (
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-2xl font-bold text-gray-900">{metrics.avgWebVitals.LCP.toFixed(0)}ms</p>
            ...
            {metrics.avgWebVitals.FID && (
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-2xl font-bold text-gray-900">{metrics.avgWebVitals.FID.toFixed(0)}ms</p>
                <p className="text-xs text-gray-500 mt-1">
            ...
            {metrics.avgWebVitals.CLS !== undefined && (
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-2xl font-bold text-gray-900">{metrics.avgWebVitals.CLS.toFixed(3)}</p>
                <p className="text-xs text-gray-500 mt-1">
            ...
            {metrics.avgWebVitals.TTFB && (
              <div className="p-4 bg-gray-50 rounded-lg">
                <p className="text-sm text-gray-600 mb-1">TTFB (Time to First Byte)</p>
                <p className="text-2xl font-bold text-gray-900">{metrics.avgWebVitals.TTFB.toFixed(0)}ms</p>
                <p className="text-xs text-gray-500 mt-1">
            ...
            {metrics.avgWebVitals.FCP && (
              <div className="p-4 bg-gray-50 rounded-lg">
                <p className="text-sm text-gray-600 mb-1">FCP (First Contentful Paint)</p>
                <p className="text-2xl font-bold text-gray-900">{metrics.avgWebVitals.FCP.toFixed(0)}ms</p>
                <p className="text-xs text-gray-500 mt-1">
      ...
      <Card className="bg-white border-gray-200">
        <CardHeader>
          <CardTitle className="text-gray-900">Métriques API</CardTitle>
          <CardDescription className="text-gray-600">Performance des endpoints API</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <span className="text-gray-700">Taux d'erreur</span>
              <span className="font-semibold text-red-400">{metrics.errorRate.toFixed(2)}%</span>
            </div>
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <span className="text-gray-700">Pic de requêtes/min</span>
              <span className="font-semibold text-gray-900">{metrics.peakRPM}</span>
            </div>
          </div>
        </CardContent>
      </Card>
