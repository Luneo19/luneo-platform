          ...
          <Tabs defaultValue="preview" className="w-full">
            ...
            <TabsContent value="preview" className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                <div>
                  ...
                  <p className="text-white font-medium">{formatBytes(model.fileSize)}</p>
                </div>
                <div>
                  <p className="text-gray-400">Type</p>
                  <p className="text-white font-medium capitalize">{model.type}</p>
                </div>
                <div>
                  <p className="text-gray-400">Format</p>
                  <p className="text-white font-medium">{model.format}</p>
                </div>
                <div>
                  <p className="text-gray-400">Créé le</p>
                  <p className="text-white font-medium">{formatDate(model.createdAt)}</p>
                </div>
              </div>
            ...
            <TabsContent value="stats" className="space-y-4">
              <div className="grid grid-cols-3 gap-4">
                <div className="p-4 bg-gray-900/50 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-white">{formatNumber(model.views)}</p>
                </div>
                <div className="p-4 bg-gray-900/50 rounded-lg">
                  <p className="text-sm text-gray-400 mb-1">Try-Ons</p>
                  <p className="text-2xl font-bold text-white">{formatNumber(model.tryOns)}</p>
                </div>
                <div className="p-4 bg-gray-900/50 rounded-lg">
            ...
            <TabsContent value="share" className="space-y-4">
              <div className="space-y-3">
                <div>
                  <p className="text-sm text-gray-400 mb-2">Lien AR</p>
                  <div className="flex gap-2">
                    ...
                    />
                    <Button variant="outline" onClick={handleCopyARLink} className="border-gray-600">
                      <Copy className="w-4 h-4" />
                    </Button>
                  </div>
                </div>
                <div>
                  <p className="text-sm text-gray-400 mb-2">Code Embed</p>
                  <div className="flex gap-2">
                    <Input
                      ...
                      className="bg-gray-900 border-gray-600 text-white text-sm"
                    />
                    <Button variant="outline" onClick={handleCopyEmbedCode} className="border-gray-600">
                      <Copy className="w-4 h-4" />
                    </Button>
                  </div>
                </div>
