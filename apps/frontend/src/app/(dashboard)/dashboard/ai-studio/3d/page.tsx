...
/**
 * Modèles 3D - AI Studio
 * Génération de modèles 3D avec IA
 */
export default function AIStudio3DPage() {
  ...
  const [generatedModels, setGeneratedModels] = useState<Array<{ id: string; name: string; thumbnail: string }>>([]);
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-400 mt-2">
              Générez des modèles 3D photoréalistes avec l'intelligence artificielle
            </p>
          </div>
        </div>
            ...
            <Card className="bg-slate-900/50 border-slate-700">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="prompt"
                    placeholder="Ex: Montre de luxe en or avec cadran bleu..."
                    value={prompt}
              ...
              <Card className="bg-slate-900/50 border-slate-700">
                <CardContent className="flex flex-col items-center justify-center py-16">
                  ...
                  <p className="text-slate-400 text-center max-w-md">
                    Configurez vos paramètres et cliquez sur "Générer le modèle 3D" pour créer votre premier modèle
                  </p>
                </CardContent>
              </Card>
            ) : (
