...
function CustomizerExamplesPageContent() {
  ...
  const tshirtExample = useMemo(() => `// T-Shirt Customizer
<ProductCustomizer
...
/>`, []);
  ...
  const mugExample = useMemo(() => `// Mug Customizer
<ProductCustomizer
  productId="mug_001"
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="p-6 bg-gray-800/50 border-gray-700 mb-8">
          ...
          <div className="relative">
            ...
            <button 
              onClick={() => copyCode(tshirtExample, 'tshirt')} 
        ...
        <Card className="p-6 bg-gray-800/50 border-gray-700">
          ...
          <div className="relative">
            ...
            <button 
              onClick={() => copyCode(mugExample, 'mug')} 
              className="absolute top-3 right-3 p-2 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-600"
            >
...
const CustomizerExamplesPageMemo = memo(CustomizerExamplesPageContent);

export default function CustomizerExamplesPage() {
  return (
    <ErrorBoundary componentName="CustomizerExamplesPage">
      <CustomizerExamplesPageMemo />
    </ErrorBoundary>
  );
}
