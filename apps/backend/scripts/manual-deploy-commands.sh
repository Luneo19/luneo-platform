...
echo "🚀 COMMANDES DE DEPLOIEMENT MANUEL LUNEO BACKEND"
echo "🌐 Connectez-vous au serveur: ssh root@116.203.31.129"
echo ""
...
echo "9️⃣ Activation du site Nginx :"
...
echo "1️⃣1️⃣ Création du répertoire de l'application :"
echo "mkdir -p /home/deploy/luneo-backend/backend"
echo ""

echo "1️⃣2️⃣ Copie du code source (depuis votre machine locale) :"
echo "scp -r /path/to/your/backend/* deploy@116.203.31.129:/home/deploy/luneo-backend/backend/"
echo ""

echo "1️⃣3️⃣ Configuration Docker Compose :"
...
echo "      - SENDGRID_API_KEY=\${SENDGRID_API_KEY}  # Set in environment"
...
echo "1️⃣4️⃣ Lancement de l'application :"
echo "cd /home/deploy/luneo-backend/backend"
echo "docker compose up -d --build"
echo ""

echo "1️⃣5️⃣ Installation de Watchtower :"
...
echo "1️⃣6️⃣ Vérification :"
echo "docker compose ps"
echo "curl http://localhost:3000/health"
echo ""

echo "🎉 DÉPLOIEMENT TERMINÉ !"
echo "🌐 Votre API sera accessible sur: https://luneo.com/api/v1"
echo "🔗 Testez avec: curl https://luneo.com/api/v1/health"
