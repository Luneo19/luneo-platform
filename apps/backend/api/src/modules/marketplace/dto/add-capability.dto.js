...
exports.AddCapabilityDto = void 0;
const class_validator_1 = require("class-validator");
const swagger_1 = require("@nestjs/swagger");
let AddCapabilityDto = (() => {
    var _a;
    ...
    return _a = class AddCapabilityDto {
            constructor() {
                ...
                this.options = (__runInitializers(this, _technique_extraInitializers), __runInitializers(this, _options_initializers, void 0));
                __runInitializers(this, _options_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _material_decorators = [(0, swagger_1.ApiProperty)({ description: 'Material name' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _technique_decorators = [(0, swagger_1.ApiProperty)({ description: 'Technique name' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
...
exports.AddCapabilityDto = AddCapabilityDto;
