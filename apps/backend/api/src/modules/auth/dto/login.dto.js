...
let LoginDto = (() => {
    ...
    return _a = class LoginDto {
        ...
        (() => {
            ...
            _password_decorators = [(0, swagger_1.ApiProperty)({ description: 'Mot de passe', example: 'SecurePass123!' }), (0, class_validator_1.IsString)({ message: 'Password must be a string' }), (0, class_validator_1.IsNotEmpty)({ message: 'Password is required' })];
