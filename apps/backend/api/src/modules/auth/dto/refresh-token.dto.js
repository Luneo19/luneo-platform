...
let RefreshTokenDto = (() => {
    ...
    return _a = class RefreshTokenDto {
        ...
        (() => {
            ...
            _refreshToken_decorators = [(0, swagger_1.ApiProperty)({ description: 'Refresh token', example: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...' }), (0, class_validator_1.IsString)({ message: 'Refresh token must be a string' }), (0, class_validator_1.IsNotEmpty)({ message: 'Refresh token is required' })];
