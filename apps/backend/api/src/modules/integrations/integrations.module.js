...
const zapier_service_1 = require("./zapier/zapier.service");
const webhook_integration_service_1 = require("./webhook-integration/webhook-integration.service");
...
let IntegrationsModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            imports: [prisma_module_1.PrismaModule, smart_cache_module_1.SmartCacheModule, axios_1.HttpModule],
            ...
            providers: [
                ...
                webhook_integration_service_1.WebhookIntegrationService,
            ],
    ...
    let _classThis;
    var IntegrationsModule = _classThis = class {
    };
