...
let OrdersController = (() => {
    let _classDecorators = [(0, swagger_1.ApiTags)('orders'), (0, common_1.Controller)('orders'), (0, swagger_1.ApiBearerAuth)()];
    ...
    (() => {
        ...
        _create_decorators = [(0, common_1.Post)(), (0, swagger_1.ApiOperation)({ summary: 'Créer une nouvelle commande' }), (0, swagger_1.ApiResponse)({
                status: 201,
                description: 'Commande créée avec URL de paiement',
            })];
        _findOne_decorators = [(0, common_1.Get)(':id'), (0, swagger_1.ApiOperation)({ summary: 'Obtenir les détails d\'une commande' }), (0, swagger_1.ApiParam)({ name: 'id', description: 'ID de la commande' }), (0, swagger_1.ApiResponse)({
                status: 200,
                description: 'Détails de la commande',
            })];
        _cancel_decorators = [(0, common_1.Post)(':id/cancel'), (0, swagger_1.ApiOperation)({ summary: 'Annuler une commande' }), (0, swagger_1.ApiParam)({ name: 'id', description: 'ID de la commande' }), (0, swagger_1.ApiResponse)({
                status: 200,
