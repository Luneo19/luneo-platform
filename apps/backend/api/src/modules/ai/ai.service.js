...
let AiService = (() => {
    ...
    var AiService = _classThis = class {
        constructor(prisma, configService, budgetService) {
            this.prisma = prisma;
        ...
        async checkUserQuota(userId, estimatedCost) {
        ...
        async updateUserQuota(userId, cost) {
        ...
        async recordAICost(brandId, provider, model, cost, metadata) {
         ...
         */
        async checkBudgetOrThrow(brandId, estimatedCost) {
            ...
            if (!hasBudget) {
                ...
                throw new common_1.BadRequestException(`Budget exceeded: ${budget.usedCents + estimatedCost} > ${budget.limitCents} cents. ` +
