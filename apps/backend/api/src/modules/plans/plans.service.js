...
exports.PlansService = exports.PlanType = void 0;
...
let PlansService = (() => {
    ...
    let _classThis;
    var PlansService = _classThis = class {
        constructor(prisma) {
            this.prisma = prisma;
            this.logger = new common_2.Logger(PlansService.name);
            this.planLimits = {
                [PlanType.STARTER]: {
                    designsPerMonth: 10,
                    teamMembers: 1,
        ...
        async upgradeUserPlan(userId, newPlan) {
