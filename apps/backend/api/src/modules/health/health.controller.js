...
let HealthController = (() => {
    ...
    (() => {
        ...
        _check_decorators = [(0, common_1.Get)(), (0, terminus_1.HealthCheck)(), (0, swagger_1.ApiOperation)({ summary: 'Health check endpoint' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Service is healthy' })];
        _getMetrics_decorators = [(0, common_1.Get)('metrics'), (0, swagger_1.ApiOperation)({ summary: 'Prometheus metrics endpoint' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Metrics in Prometheus format' })];
