...
const app_error_filter_1 = require("./errors/app-error.filter");
const validation_pipe_1 = require("./utils/validation.pipe");
const rate_limit_guard_1 = require("@/libs/rate-limit/rate-limit.guard");
const rate_limit_module_1 = require("@/libs/rate-limit/rate-limit.module");
const i18n_module_1 = require("@/libs/i18n/i18n.module");
const timezone_module_1 = require("@/libs/timezone/timezone.module");
const i18n_middleware_1 = require("@/common/middleware/i18n.middleware");
let CommonModule = (() => {
    let _classDecorators = [(0, common_1.Global)(), (0, common_1.Module)({
            ...
            providers: [
                ...
                },
                {
                    ...
                    useClass: app_error_filter_1.AppErrorFilter,
                },
                validation_pipe_1.ValidationPipe,
                i18n_middleware_1.I18nMiddleware,
            ],
            exports: [validation_pipe_1.ValidationPipe, i18n_module_1.I18nModule, timezone_module_1.TimezoneModule],
        })];
