...
export class ApiKeysService {
   ...
   */
  async assertApiAccessAllowed(organizationId: string, userRole: PlatformRole | string): Promise<void> {
    if (userRole === PlatformRole.ADMIN || (userRole as string) === 'SUPER_ADMIN') {
      return;
    }
