...
export enum AuditAction {
  ...
  // SECURITY FIX: Added missing admin billing audit actions
  ADMIN_BRAND_PLAN_CHANGED = 'ADMIN_BRAND_PLAN_CHANGED',
  ADMIN_BRAND_STATUS_CHANGED = 'ADMIN_BRAND_STATUS_CHANGED',
