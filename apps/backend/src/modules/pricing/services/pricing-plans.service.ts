...
export class PricingPlansService {
  ...
  private readonly plans: Record<PlanType, PlanConfig> = {
    pro: {
      ...
      limits: {
        ai_generations: PLAN_CONFIGS[PlanTier.PRO].quotas.find(q => q.metric === 'messages_ai')?.limit ?? 20_000,
        ar_sessions: PLAN_CONFIGS[PlanTier.PRO].limits.conversationsPerMonth,
        ...
        renders_2d: PLAN_CONFIGS[PlanTier.PRO].limits.conversationsPerMonth,
        renders_3d: Math.floor(PLAN_CONFIGS[PlanTier.PRO].limits.conversationsPerMonth / 10),
      },
    ...
    business: {
      ...
      features: [
        `${PLAN_CONFIGS[PlanTier.BUSINESS].limits.conversationsPerMonth} conversations/mois`,
        'Virtual Try-On',
      ...
      limits: {
        ai_generations: PLAN_CONFIGS[PlanTier.BUSINESS].quotas.find(q => q.metric === 'messages_ai')?.limit ?? 150_000,
        ar_sessions: PLAN_CONFIGS[PlanTier.BUSINESS].limits.conversationsPerMonth,
        ...
        designs_per_month: PLAN_CONFIGS[PlanTier.BUSINESS].limits.conversationsPerMonth,
        renders_2d: PLAN_CONFIGS[PlanTier.BUSINESS].limits.conversationsPerMonth,
        renders_3d: Math.floor(PLAN_CONFIGS[PlanTier.BUSINESS].limits.conversationsPerMonth / 10),
      },
      addOns: ['ai_credits', 'ar_sessions', 'storage_gb', 'api_calls', 'team_members'],
    },
    enterprise: {
