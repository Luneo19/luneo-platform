...
export class BillingEnhancedService {
  ...
  async createCheckoutSession(
    ...
    const sessionParams: Stripe.Checkout.SessionCreateParams = {
      ...
      success_url: (this.configService.get<string>('app.frontendUrl') || 'https://luneo.app') + '/dashboard/billing?success=1',
      cancel_url: (this.configService.get<string>('app.frontendUrl') || 'https://luneo.app') + '/dashboard/billing?cancel=1',
